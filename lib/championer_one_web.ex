defmodule ChampionerOneWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ChampionerOneWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/championer_one_web/templates",
                        namespace: ChampionerOneWeb
